...
class BGALayer(nn.Module):
    ...
    def __init__(self, left_width=128, right_width=128):
        ...
        self.left1 = nn.Sequential(
            ...
            nn.Conv2d(
                left_width, left_width, kernel_size=1, stride=1,
                padding=0, bias=False),
        )
        self.left2 = nn.Sequential(
            nn.Conv2d(
                left_width, left_width, kernel_size=3, stride=2,
        ...
        self.right2 = nn.Sequential(
            ...
            nn.BatchNorm2d(right_width),
            nn.Conv2d(
                right_width, right_width, kernel_size=1, stride=1,
                padding=0, bias=False),
        )
...
class BiSeNetV2(nn.Module):
    ...
    def __init__(self, n_classes, aux_mode='train'):
        ...
        self.bga = BGALayer(4 * self.ch, 4 * self.ch)
...
if __name__ == "__main__":
    ...
    #                   "BiSeNetV2_search_5G.onnx", verbose=True)
    # print('onnx exported')

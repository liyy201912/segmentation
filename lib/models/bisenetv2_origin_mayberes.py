...
#             ConvBNReLURes(64, 64, 3, stride=1),
#         )
...
#             ConvBNReLURes(128, 128, 3, stride=1),
#             ConvBNReLURes(128, 128, 3, stride=1),
#         )
#
#     def forward(self, x):
...
class CEBlock(nn.Module):
    ...
    def __init__(self):
        ...
        # self.conv_last = ConvBNReLURes(128, 128, 3, stride=1)
...
class BGALayer(nn.Module):
    ...
    def __init__(self):
        ...
        # self.conv = ConvBNReLURes(128, 128, 3, 1, 1, bias=False)
